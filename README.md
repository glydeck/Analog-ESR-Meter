...
Additional information including parts list, schematic and circuit description can be found in the file **ESR Meter Manual.pdf** which is included in this repository.
